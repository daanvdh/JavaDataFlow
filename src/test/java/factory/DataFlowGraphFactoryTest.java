...
public class DataFlowGraphFactoryTest {
  ...
  private DataFlowMethod.Builder createMethod(String name, DataFlowNode... params) {
    MethodDeclaration m = new MethodDeclaration();
    m.setName(new SimpleName(name));
    DataFlowMethod.Builder method = DataFlowMethod.builder().name(name).representedNode(m);
